...
int main()
{
	...
	*/
	...
	glm::mat4 pata2(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// Torso del cuerpo del animal 3D
		modelaux = model;
		model = glm::translate(model, glm::vec3(0.0f, 2.0f, -4.0f));
		model = glm::scale(model, glm::vec3(6.0f, 2.5f, 3.0f));
		...
		// Tercera pata del animal

		// Articulacion 1:2
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(2.5f, 1.0f, -5.5f));
		...
		// Cabeza del animal 3D

		model = glm::mat4(1.0);

		model = glm::translate(model, glm::vec3(-3.5f, 3.5f, -4.0f));
		modelaux = model;
		...
		model = glm::translate(model, glm::vec3(-2.5f, 5.0f, -3.0f));
		...
		model = glm::translate(model, glm::vec3(-2.5f, 5.0f, -5.0f));
