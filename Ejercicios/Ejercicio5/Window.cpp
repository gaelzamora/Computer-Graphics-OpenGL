...
Window::Window()
{
	width = 800;
	height = 600;
	articulacion1Direction = 1.0f;
	articulacion2Direction = 1.0f;
	articulacion3Direction = 1.0f;
	articulacion4Direction = 1.0f;
	articulacion5Direction = 1.0f;
...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	if (key == GLFW_KEY_F)
	{
		...
		{
			theWindow->articulacion1Direction = -1.0f;
		}
		...
		theWindow->articulacion1 += 10.0f * theWindow->articulacion1Direction;
	}
	...
	if (key == GLFW_KEY_G)
	{
		...
		{
			theWindow->articulacion2Direction = -1.0f;
		}
		...
		theWindow->articulacion2 += 10.0f * theWindow->articulacion2Direction;
	}
	if (key == GLFW_KEY_H)
	{
	...
	if (key == GLFW_KEY_J)
	{
		...
		{
			theWindow->articulacion4Direction = -1.0f;
		}
		...
		theWindow->articulacion4 += 10.0f * theWindow->articulacion4Direction;
	}
	if (key == GLFW_KEY_K)
	{
		if (theWindow->articulacion5 >= 45.0f)
		{
			theWindow->articulacion5Direction = -1.0f;
		}
		...
		theWindow->articulacion5 += 10.0f * theWindow->articulacion5Direction;
	}
	if (key == GLFW_KEY_L)
	{
