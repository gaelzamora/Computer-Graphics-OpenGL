...
// average normals
	GLfloat cubo_vertices[] = {
		...
		0.5f,  0.5f,  0.5f,		0.74f,	0.32f,		0.0f,	0.0f,	-1.0f,	//2
		-0.5f,  0.5f,  0.5f,	0.51f,	0.32f,		0.0f,	0.0f,	-1.0f,	//3
		// right
		//x		y		z		S		T
...
int main()
{
	...
	DadoAnimales_M.LoadModel("Models/dado_animales.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		/*Reporte de práctica :
		Ejercicio 1: Crear un dado de 8 caras y texturizarlo por medio de códig	o
